...
var RUNE_IMAGES = [
  ...
  ['Kenaz','any','Aflinn glóir í dimmri smiðjunni og hamarinn mótar járnið.','The forge glows in the dark shed and the iron takes its shape.','kyndill','fire'],
  ...
  ['Kenaz','any','Það logar á einum lampa yfir hefilbekknum og spænirnir liðast undan egginni.','A single lamp over the bench and the shavings curl away from the blade.','sköpunargleði','creativity'],
  ...
  ['Wunjo','any','Það er kveikt á lömpunum snemma og húsið fyllist af röddum áður en maturinn er tilbúinn.','The lamps are lit early and the house fills with voices before the food is ready.','tilheyra','belonging'],
  ['Wunjo','any','Ein rödd byrjar sönginn og stofan tekur undir, línu fyrir línu.','One voice starts the song and the room finds it line by line.','tilheyra','belonging'],
  ...
  ['Isa','cold','Lognkafaldið fellur beint niður og hylur allt hljóðlaust.','The windless snowfall comes straight down and covers everything without a sound.','kyrrstaða','stillness'],
