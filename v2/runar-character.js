...
var RUNE_IMAGES = [
  ...
  ['Kenaz','any','Glæðurnar lifa undir öskunni fram á morgun.','The embers stay alive under the ash until morning.','innri ljós','inner light','D'],
  ...
  ['Perth','any','Eitthvað liggur á botni lónsins og bíður eftir að vera dregið upp.','Something lies on the bottom of the lagoon, waiting to be drawn up.','hið hulda','hidden things','E'],
  ['Perth','any','Bréf liggur óopnað á borðinu og þú veist ekki enn hvað í því stendur.','A letter lies unopened on the table and you do not yet know what it says.','hið hulda','hidden things','D'],
