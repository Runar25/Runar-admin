...
const UI_TEXT = {
  ...
  en: {
    ...
    founding_done_text:  'The roots are set. Your tree stands — and from here it grows with every rune you draw.',
    founding_done_btn:   'GO TO YOUR TREE',
  ...
  is: {
    ...
    founding_done_text:  'Rætur eru komnar niður. Tréð þitt stendur — og héðan í frá vex það með hverri rún sem þú dregur.',
    founding_done_btn:   'FARA AÐ TRÉNU ÞÍNU',
