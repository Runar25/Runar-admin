...
const UI_TEXT = {
  ...
  is: {
    ...
    rs_banner_desc:     'Þú gengur sem <strong>Vegfarandi</strong> \u2014 {casts_month} til að byrja, allar tuttugu og fimm rúnirnar opnar, Rúnar hlustandi.<br><br>Þegar hún er gengin og steinarnir eiga enn eftir að segja, opnar {card} dyrnar. Eitt kort. Jafn margar spár og þú berð. Engin gildistími, engin áskrift.',
    rs_credits_counter: '{units} eftir',
    rs_credits_desc:    'Frjáls spá þín er uppgengin. Næsta spá verður tekin úr inneign þinni.',
    rs_exhausted_one:   'Þú hefur gengið frjálsu spá þína. Opnaðu dyrnar með <b>{card}</b> \u2014 eitt kort, engin gildistími, engin áskrift.',
    rs_exhausted_many:  'Þú hefur gengið allar {n} frjálsu spárnar þínar. Opnaðu dyrnar með <b>{card}</b> \u2014 eitt kort, engin gildistími, engin áskrift.',
