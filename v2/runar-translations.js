...
const UI_TEXT = {
  ...
  en: {
    ...
    name_no_norse_from: 'Rúnar sees no Norse root in this name — its roots lie elsewhere ({origin}).',
  ...
  is: {
    ...
    name_no_norse_from: 'Rúnar sér enga norræna rót í þessu nafni — rætur þess liggja annars staðar ({origin}).',
