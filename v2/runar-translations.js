...
const UI_TEXT = {
  ...
  en: {
    ...
    readings_renewed:   'YOUR CASTS HAVE RENEWED',
    continue_btn:       'CONTINUE',
    dam_title:          'DELETE YOUR ACCOUNT?',
    delete_btn:         'DELETE',
    cancel_btn:         'CANCEL',
    deleting_btn:       'DELETING...',
    journal_title:      '\u2726 YOUR CASTS',
    journal_empty:      'No casts recorded yet.<br>Draw your first rune.',
    jcard_select:       '\u2605 SELECT',
    ...
    reading_error:      'Error generating cast.',
    ...
    rs_credits_desc:    'Your monthly cast is complete. R\u00fanar will draw from your {units} for the next cast.',
    rs_exhausted_one:   'You have walked your free cast this month. The stones rest until the new month \u2014 or keep the door open with a <b>{card}</b>. One card. No expiry, no subscription.',
    rs_exhausted_many:  'You have walked all {n} casts this month. The stones rest until the new month \u2014 or keep the door open with a <b>{card}</b>. One card. No expiry, no subscription.',
    visitor_counter:    '{casts} remaining',
    visitor_desc:       'You walk here as a <strong>Visitor</strong>. One cast opens before you \u2014 draw a rune and hear what R\u00fanar sees in the stones.<br><br>When you are ready to walk with all twenty-five runes and hear R\u00fanar speak in your own cast, become a <strong>Rune Seeker</strong> \u2014 it costs nothing.',
    visitor_exhausted:  'Your free cast as a Visitor is complete. Become a <strong>Rune Seeker</strong> \u2014 it costs nothing, and all twenty-five runes open before you.',
