...
const UI_TEXT = {
  ...
  en: {
    ...
    ask_placeholders:   ['What is this asking me to let go of?',
                         'Is this telling me to wait, or to act?',
                         'Why does this keep showing up in my life?',
                         'Does this confirm what I already feel?',
                         'What am I not seeing here?',
                         'What should I focus on first?',
                         'Is there something here I am avoiding?'],
  ...
  is: {
    ...
    ask_placeholders:   ['Hvað er þetta að biðja mig að leggja frá mér?',
                         'Er þetta að segja mér að bíða — eða að hefjast handa?',
                         'Af hverju kemur þetta aftur og aftur upp í lífi mínu?',
                         'Staðfestir þetta það sem ég finn nú þegar?',
                         'Hvað er það sem ég sé ekki hér?',
                         'Að hverju ætti ég að einbeita mér fyrst?',
                         'Er eitthvað hér sem ég er að forðast?'],
