...
const UI_TEXT = {
  ...
  en: {
    ...
    visitor_desc:       'You walk here as a <strong>Visitor</strong>. One rune reading opens before you \u2014 draw a rune and hear what R\u00fanar sees in the stones.<br><br>When you are ready to walk with all twenty-five runes and hear R\u00fanar speak in your own rune reading, become a <strong>Rune Seeker</strong> \u2014 free to join.',
    visitor_exhausted:  'Your free rune reading as a Visitor is complete. Become a <strong>Rune Seeker</strong> \u2014 free to join, and all twenty-five runes open before you.',
  ...
  is: {
    ...
    visitor_desc:       'Þú gengur hér sem <strong>Gestur</strong>. Fehu \u2014 rúna upphafsins \u2014 opnar rödd sína fyrir þig frítt. Dragðu hana. Hlustaðu á það sem fornir steinar hvísla.<br><br>Þegar þú ert tilbúinn að ganga með allar tuttugu og fimm rúnirnar og heyra Rúnar tala í spá þína, vertu <strong>Leitandi</strong> \u2014 skráning er ókeypis.',
    visitor_exhausted:  'Þú hefur notað frjálsu spá þína sem Gestur. Vertu <strong>Leitandi</strong> \u2014 ókeypis, og allar tuttugu og fimm rúnirnar opnast þér.',
