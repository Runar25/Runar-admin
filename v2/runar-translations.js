...
const UI_TEXT = {
  ...
  en: {
    ...
    founding_story_text: 'Your life rune was already yours — the rune you were born under; it needed no asking. What comes now is the rooting. Three runes for the three who tend the well beneath the tree: Urður, who holds what has been. Verðandi, who holds what is becoming. Skuld, who holds what is still owed. Draw them, and the tree is yours. Every rune you draw after these makes it grow.',
  ...
  is: {
    ...
    founding_story_text: 'Lífsrúnin var þín frá upphafi — rúnin sem þú fæddist undir; um hana þurfti ekki að biðja. Nú koma ræturnar. Þrjár rúnir fyrir þrjár sem sitja við brunninn undir trénu: Urður, sem geymir það sem var. Verðandi, sem geymir það sem er að verða. Skuld, sem geymir það sem á eftir að koma. Dragðu þær, og tréð er þitt. Hver rún sem þú dregur eftir þessa lætur það vaxa.',
