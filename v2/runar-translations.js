...
const UI_TEXT = {
  ...
  en: {
    ...
    ask_placeholders:   ['Ask Rúnar about this reading…', 'What in this reading stays with you?', 'What would you ask the runes?', 'Is there a word here you want to understand?'],
    ask_btn:            'ASK',
  ...
  is: {
    ...
    ask_placeholders:   ['Spyrðu Rúnar um þennan lestur…', 'Hvað í lestrinum situr eftir hjá þér?', 'Hvað myndir þú spyrja rúnirnar?', 'Er orð hér sem þú vilt skilja betur?'],
    ask_btn:            'SPYRJA',
