...
async function callProxy(sys, prompt, maxTokens, use_credit = false, credit_cost = 1, journal = null, mode = '', spread = '') {
  try {
    ...
    const res  = await fetch(PROXY, {
      method: 'POST', headers,
      body: JSON.stringify({ system: sys, prompt, max_tokens: maxTokens, use_credit, spread_cost: credit_cost, journal, mode, spread })
    });
