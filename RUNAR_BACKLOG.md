...
- [ ] **Zastaralý komentář u Yggdrasil builderů** (runar-character.js ~ř. 1668, nalezeno 2026-08-23):
  říká „jednou ročně, zimní slunovrat (Dec 14–28). Premium." — obojí proti kánonu <!-- check-docs:ok 2026-08-23 cituje mrtvy pojem jako mrtvy (nalez recidivy, ne pravidlo) --> (CLAUDE.md:
  Yggdrasil = kdykoliv, kdokoliv přihlášený; slunovrat = síla ve stromě, ne brána; gating jen
  visitor). Přesně recidiva, před kterou CLAUDE.md varuje. Opravit při nejbližším §1 patchi
  do souboru (komentář-only; samostatný commit by jen honil sw bump).
