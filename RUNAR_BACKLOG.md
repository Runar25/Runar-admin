...
- [ ] ⛔ **TŘI RUNY SE V PRODUKCI NEČTOU JAKO ONY SAMY** (identitní test 2026-09-09, cela A = nedotčená produkce, volba ze všech 25 run, náhoda 4 %). **Uruz → Eihwaz 2/2 · Algiz → Thurisaz/Isa 2/2 · Tiwaz → Kenaz/Isa 2/2.** Dalších pět run selhává 1/2: Wunjo, Hagalaz, Jera, Mannaz, Blank. **Celkem 8 z 25.** Není to otázka pestrosti, je to **vada přiřazení** — uživatel dostane čtení, které mluví o jiné runě, než jakou si vytáhl. ⭐ **Patří na ZAČÁTEK paletového auditu, před psaní nových obrazů.**
  ⚠️ **Dvě gravitační jámy:** `Isa` přijala 13 čtení od 6 run · `Laguz` 11 čtení od 9 run. Nejčastější záměna **Tiwaz → Isa 5×**: „drží, nehne se s ním" sedí na Isu líp než na Tiwaz, a Tiwaz nemá v obrazech nic o spravedlnosti ani odvaze. → **Kritérium pro paletu: runa potřebuje obraz, který ji odliší od SOUSEDA, ne jen obraz, který ji vystihuje.**
  ⚠️ Rodina „voda, loď, břeh" je jako obecná rodina předmětů špatně zvolená — sama vyrobila 6 z 11 záměn za Laguz (je to sémantické pole jedné runy).
