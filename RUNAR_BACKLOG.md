...
- [ ] **§22 — rozpor v čísle „nároky na vnitřní stav"** (nalezeno 2026-09-08): `v2/runar-reader.html:287` říká „4 % proti **23 %** u čtení", `RUNAR_EVAL_LOG.md` rejstřík pák (řádek `angle`) říká „Ask 4 % · spread 10 % · **single 18 %**". Táž metrika, dvě čísla, dvě místa. Původní měření (18. 8.) jsem v živém logu nenašel — **neověřil jsem, které je správné.** Dohledat a nechat žít **jedno** (§20); komentář v HTML pak jen odkáže.
