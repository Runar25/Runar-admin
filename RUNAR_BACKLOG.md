...
- [ ] ⭐ **MOŽNOST: KRÁTKÉ OBRAZY (2–4 slova) v `RUNE_IMAGES` místo celých vět** (KUKY 2026-09-14 po testech,
  ...
  **Cíl ownera pro význam** (patří k položce „VÝKLAD JE METAFORA VEDLE METAFORY" výš): *„když se uživatel na nic
  neptá, měl by dostat jen obecné znění runy; pokud přidá AREA, mělo by to být ve čtení vidět."* Vzor z ChatGPT, který
  owner přinesl: *„RAIDHO je runa cesty, pohybu a správného směru… něco se dává do pohybu a postupně zapadá do svého
  řádu."* ⚠️ Druhá půlka téhož vzoru je RADA (*„Její rada je…"*, *„pomůže otevřená domluva"*) — to kánon vylučuje
  (`RUNAR_DESIGN.md` „Cold reading: pojmenovaný anti-vzor": *„postoj ano, radu ne"*). Brát z něj význam, ne radu.
