...
- [ ] **Smí CODE-reader psát do `RUNAR_DESIGN.md`? (2026-08-18, owner).** Lanes v `CLAUDE.md` dávají design a docs **Coworku**; CODE-reader tam přesto píše (`1eaced0`, `eaa96c0`). Buď je to vědomá výjimka a patří do lanes jako věta, nebo je to druhá kolize po té s prefixem. CODE-tune to nerozhoduje — je to o tom, kdo vlastní obsah.
