...
- [ ] **Přerušené čtení (stop od uživatele) zapíše do deníku PRÁZDNÝ řádek** (2026-08-23: Berkana 18:10 + Jera 18:18 — owner potvrdil, že je stopnul sám; kredit nestržen ✓). Vada je kosmetická, ale reálná: deník uživatele nese prázdné položky. K rozhodnutí/opravě: přerušené čtení buď nejournalovat vůbec, nebo řádek po abortu uklidit; guard v klientovi (neposílat journal bez textu) je nejlevnější. Netriviální jen o tom, KDY klient journal posílá vs. kdy stream končí.
