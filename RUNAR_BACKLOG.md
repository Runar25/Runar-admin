...
- [ ] **„blind side" v `_registerContext` (Confirmation, EN+IS) — personifikující idiom** (handoff Cowork 2026-08-22): bezpečný podmět, ale idiom skoro vždy o povědomí osoby — táž rodina jako opravené „beneath the surface" v úhlu. Tři návrhy přepisu v handoffu (A prostorový · B kotvený v obraze · C minimální), IS znění NEOVĚŘENÁ. ⚠️ Blok „co hledám" je od 2026-08-22 K LEDU (rozhodnutí ownera — ladí se čtení samo); řešit AŽ při jeho návratu, testem přes atribuci (zamčený zbytek, n≥8, oba jazyky), ne rovnou nasazením. Metodická přidaná hodnota hned: test „personifikující idiom" — použil-li by se výraz o člověku, znamenal by skoro vždy „něco, co o sobě neví"? — přidat vedle čáry podmětu při psaní příštích řádek promptu.
