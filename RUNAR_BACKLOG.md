...
- [ ] ⚠️ **PUSTIT SQL: `sql/2026-07-19_life_rune_immutable.sql`** — brana proti prepsani zivotni runy. **BLOKUJE zlevneni Life Rune na 0** (dnes je jedina brzda proti prepsani prave ta cena). Po pusteni: admin reset prestane fungovat jako tlacitko a dela se SQL prikazem z konce te migrace (ten navic maze i `tree_name`, coz stare tlacitko nedelalo).
