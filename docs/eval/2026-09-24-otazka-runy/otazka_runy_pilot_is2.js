...
const RAMEC = q => 'Láttu hana eiga rót í spurningu rúnarinnar („' + (q.indexOf(':') !== -1 ? q.slice(q.indexOf(':') + 1).trim() : q) + '“) en segðu hana með þínum eigin orðum.';
...
(async () => {
  ...
  fs.writeFileSync(__dirname + '/otazka_runy_pilot_is2.json', JSON.stringify(out, null, 1));
})();
