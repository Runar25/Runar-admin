// CODE-read 2026-09-24 — odslepi souzeni Opus 5 × Opus 4.8 (workflow opus5-vs-opus48-slepi-soudci) klicem ../opis-klic3.json.
//   node opus5_soudy.js <vystup workflow {vysledky:[…]}>
'use strict';
const fs = require('fs'), path = require('path');
const klic = JSON.parse(fs.readFileSync(path.join(__dirname, '..', 'opis-klic3.json'), 'utf8'));
...
fs.writeFileSync(path.join(__dirname, 'soud3', 'odslepene.json'), JSON.stringify(rows, null, 1));
