# RUNAR_EVAL_LOG — archiv měření 2026-08-06 → 2026-08-17

**Historický záznam. Není to popis dneška.** Odsunuto 2026-08-21, protože živý
`RUNAR_EVAL_LOG.md` měl 1 729 řádků proti pravidlu ~200 a detail už nikdo nečetl.

⚠️ **Trvalé závěry z těchhle měření drží „Rejstřík pák" v živém `RUNAR_EVAL_LOG.md`.**
Sem se chodí pro detail — jak se to měřilo, na jakém n, s jakou mezí citlivosti.
Nikdy odsud neber aktuální stav; ten vlastní produkce a živý log.
