...
`C:\Users\zkuku\Downloads\Runar-admin\v2\`: `runar-tree-model.js` (čistá logika,  <!-- doc-links:ok 2026-07-19 legacy: vzniklo před pravidlem, důvod nedoplněn -->
bez DOM — React Native ready), `runar-tree-render.js` (Canvas 2D, dual-canvas),  <!-- doc-links:ok 2026-07-19 legacy: vzniklo před pravidlem, důvod nedoplněn -->
`runar-tree-lab.html` (mock data + time-travel slider). Generuje se přes  <!-- doc-links:ok 2026-07-19 legacy: vzniklo před pravidlem, důvod nedoplněn -->
`build_tree_lab.py` (pravidlo §1: JS jen přes Python skripty).  <!-- doc-links:ok 2026-07-19 legacy: vzniklo před pravidlem, důvod nedoplněn -->
...
· HYBRID: v2/tree-lab-hybrid/ (build_tree_hybrid.py patchuje v0.7 model). Norns osy:
  ...
  Hlavní lab v2/runar-tree-lab.html = pořád liana v0.7.  <!-- doc-links:ok 2026-07-19 legacy: vzniklo před pravidlem, důvod nedoplněn -->
