...
- **SEASON_POOLS rebalance (2026-07-16, prompt v0.8)**: podíl vodních obrazů sražen (highsummer 44 %, earlysummer 35 % → pevnina; autumn byl vzor s 0 %). −5 mořských (hs_seafog, hs_coldsea, hs_terns, es_coastfog, es_seasnap), dw_stars přepsán z „still fjord" na svörtu hrauninu, +4 pevninské (hrafn/fjöll, stuðlaberg, mosi/hraun, stakt fjall). IS ověřeno (is-grammar-qa čisté; `svörtu hrauninu` = týž vzor jako nahrazované `kyrrum firðinum`). **Efekt NEZMĚŘEN** — čeká na eval dávku v0.8 vs v0.7.
