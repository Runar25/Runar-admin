...
- [snapshots/2026-08-20-identita-session-a-uhly.md](snapshots/2026-08-20-identita-session-a-uhly.md) — ㉛ identita session OSTRÁ (3/3, generický podpis blokuje push) · Stop-hook hlídá i neverzované `memory/` · úhly ověřené měřením ← NEJNOVĚJŠÍ
