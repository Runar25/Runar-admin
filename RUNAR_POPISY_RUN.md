# RUNAR_POPISY_RUN.md
# Uživatelské popisy run — jak se runa chová, co může naznačovat, jaké obrazy tvoří, jakou otázku klade.
# Vlastní tenhle doc a žádný jiný (§20). Jinde bydlí: data run (aett, keywords, element, svět)
...
**K čemu to je (dvě věci, obě schválené 2026-09-22):**
1. **Návod pro uživatele** — jak čtení run probíhá, proč Rúnar mluví obrazem, co má člověk hledat.
   Popisy jsou jeho surovina, ne jeho hotová podoba.
2. **Zdroj pro prompt** — nápady na obrazy (`RUNE_IMAGES`), na to, jak Rúnar mluví, a na vstupy,
   které do promptu chodí (úhly, esence, tvary zakončení). Každý takový přenos = vlastní rozhodnutí
   v `RUNAR_DECISIONS.md`, ne tichý import.

⚠️ **Jazyk: čeština je PRACOVNÍ zdroj, ne produkční text.** Až z toho poroste UI text nebo prompt,
islandština se **píše nativně** a ověřuje (`is-vazba.py`, `is-grammar-qa.py`) — nikdy jako překlad
téhle češtiny (§2: „IS se VYMÝŠLÍ, ne překládá"). Totéž platí pro angličtinu.

**Společný tvar, který popisy drží** (pozorování, ne pravidlo — pravidlo vznikne, až jich bude 25+):
runa se nejdřív **ukáže jako obraz nebo gesto** → pak **co dělá / co nedělá** → pak **kdy se objevuje**
...
Fehu je něco, co proudí.

Přichází jako voda do nádoby — chvíli je jí málo, potom přeteče. A právě proto Fehu není jen obraz bohatství. Je to síla, která má hodnotu tehdy, když se může pohybovat.

Může to být peníze, práce, energie, nápad, pozornost, vztah nebo něco, co jsi vytvořil vlastníma rukama. Něco je u tebe a může z toho vzniknout něco dalšího.

Fehu proto ukazuje nejen na to, co máš, ale také na to, co s tím děláš.

Někdy přichází v okamžiku, kdy se něco začíná otevírat. Je tu možnost růstu. Něco má potenciál získat větší hodnotu, pokud tomu dáš prostor.

Ale Fehu má i druhou stranu.

To, co proudí dovnitř, může také odtéct.
To, co živíš, roste.
To, co necháš stát, může ztratit svou sílu.

Fehu tedy není slib, že něco získáš.

Je to obraz živé hodnoty, která prochází tvýma rukama.

A možná se ptá:

Co máš právě teď ve svých rukou, co by mohlo začít žít, kdybys tomu dovolil proudit?

---

## Uruz

Uruz přichází z místa, kde ještě není hotový tvar.

Je to síla těla, země a života, který se nezastavuje proto, že cesta není pohodlná. Jako divoký pratur — těžký, silný, nezkrocený. Neptá se, jestli může projít. Prostě má sílu pokračovat.

Uruz proto není síla, kterou člověk předvádí.

Je to síla, kterou poznáš ve chvíli, kdy ji potřebuješ.

Někdy přichází jako období, které tě nutí změnit se. Něco starého už nestačí, ale nové ještě nemá jasný tvar. Uruz v takovém okamžiku nepřináší hotovou odpověď.

Přináší schopnost proměny.

Je v ní něco syrového. Něco, co ještě nebylo uhlazené zkušeností ani rozumem. A právě proto může být Uruz někdy nepohodlný. Nutí člověka setkat se s vlastní silou — i s jejími hranicemi.

Neříká: buď silnější.

Spíš ukazuje:

Tady je síla, která v tobě už je. Co z ní může vzniknout?

---

## Thurisaz

Thurisaz stojí u dveří.

Není to ještě krok dovnitř ani ven. Je to okamžik, kdy se něco zastaví — a právě tím vznikne prostor, aby bylo možné vidět, co se děje.

Je v ní síla trnu. Ostrá hranice, která neříká pojď dál, ale také neříká odej. Říká: pozor.

